...
class kalendarz {  
    ...
    public function _getYear(){
        $temp = $this->currentYear;
        return $temp;
    }
    public function _getMonth(){
        $temp1 = $this->currentMonth;
        return $temp1;
    }
...
private function _showDay($cellNumber){
        ...
        {
            return '<a href=dodawanie_eventu.php?day='.$this->currentDay.'&month='.$this->currentMonth.'><li id="li-'.$this->currentDate.'" class="'.($cellNumber%7==1?' start ':($cellNumber%7==0?' end ':' ')).
