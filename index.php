		...
		if ($result -> num_rows > 0)
		{
	 		...
	 		{	
	 			echo '<div class=event1>';
	       		echo ' <b>'.$row["tytul"].'</b><br>Data: '.$row['dzien'].'.'.$row['miesiac'].'.'.$row['rok'].' godz. '.mb_substr($row['godzina'], 0, 5).'<br>Opis: '.$row['opis'].'<br><br><a class="button" href="usuwanie.php?id='.$row['id'].'">Usuń wydarzenie</a></div>';
			}
